...
import NotificationDialog from '../utils/dialog';
import { dialogParams } from './type';
...
export default function SlideOverNewGaterway() {
    ...
    const handleDialogContentChange = (state: dialogParams) => {
        setDialog({
            ...dialog,
            open: state.open,
            title: state.title,
    ...
    const handlerSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        let toastNotification: dialogParams = {
            open: true,
        ...
        const url = 'http://127.0.0.1:8000/gaterways/create';
        fetch(url, {
            method: 'POST',
        ...
        <>
            ...
            {dialog.open && (
                <NotificationDialog
                    ...
                    toggleDialog={handleDialogStatusChange}
                />
            )}
        </>
    );
